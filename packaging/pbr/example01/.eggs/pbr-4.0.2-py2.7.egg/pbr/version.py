...
class SemanticVersion(object):
    ...
    def _sort_key(self):
        ...
        if self._dev_count and not self._prerelease_type:
            ...
            uq_dev = 1
        return (self._major, self._minor, self._patch, uq_dev,
    ...
    def _from_pip_string_unsafe(klass, version_string):
        ...
        if digit_len == 0:
            ...
            if (digit_len < len(input_components)
                ...
                last_component = ''.join(
                    itertools.takewhile(lambda x: x.isdigit(),
                                        mixed_component))
        ...
        if remainder_starts_with_int:
            ...
            if remainder and (remainder[0][0] == '0'
                              or remainder[0][0] in ('a', 'b', 'r')):
...
class VersionInfo(object):
    ...
    def __repr__(self):
        """Include the name."""
        return "pbr.version.VersionInfo(%s:%s)" % (self.package,
                                                   self.version_string())
