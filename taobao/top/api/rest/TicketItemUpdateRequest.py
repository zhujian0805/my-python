...
class TicketItemUpdateRequest(RestApi):
    ...
    def getTranslateParas(self):
        return {
            'etc_verification_pay': 'etc.verification_pay',
            'etc_merchant_nick': 'etc.merchant_nick',
            'etc_network_id': 'etc.network_id',
            'etc_overdue_pay': 'etc.overdue_pay',
            'etc_auto_refund': 'etc.auto_refund',
            'etc_merchant_id': 'etc.merchant_id',
            'etc_association_status': 'etc.association_status'
        }
